...
export const AddExpenseModal: React.FC<AddExpenseModalProps> = ({ visible, onClose, onAdded }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Toast.show({ type: 'success', text1: 'Despesa adicionada com sucesso!' });
      resetForm();
      onAdded();
      onClose();
    } catch (err: unknown) {
      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.footer}>
          <TouchableOpacity
            ...
            disabled={isLoading}
          >
            <Text style={styles.submitText}>{isLoading ? 'Salvando...' : 'Salvar Despesa'}</Text>
          </TouchableOpacity>
        </View>
      </SafeAreaView>
    </Modal>
